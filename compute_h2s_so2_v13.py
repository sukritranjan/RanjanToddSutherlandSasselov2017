...
###Control Switches
########################
run_ph2s_pso2_chem=True #If true, runs pH2s, pSO2 calculations (Purpose 1). If False, does not.
run_s_flux_chem=True #If true, calculates everything as funciton of S-flux for buffered reservoir. (Purpose 2)
